...
extension PopoverController {
    func buildPopover() {
        ...
        configureIconButton(respeakButton, symbol: "speaker.badge.exclamationmark", action: #selector(respeak), label: "Fetch new speech")
        ...
        sourceHeaderBar.addSubview(dictateSourceButton)
        ...
        resultHeaderBar.addSubview(respeakButton)
