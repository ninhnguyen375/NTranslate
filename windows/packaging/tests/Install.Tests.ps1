...
} -GetSignature { [pscustomobject]@{ Status = 'Valid'; SignerCertificate = [pscustomobject]@{ Subject = 'CN=Ninh Nguyen' } } } -InvokeLayout { } -ResolveTool { param($Name) "C:\fixture\$Name" } -GetDevelopmentCertificate { [pscustomobject]@{ Thumbprint = '0123456789ABCDEF0123456789ABCDEF01234567' } }
